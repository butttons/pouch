/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0193a950e6f6358c846d52472d8f6ce8)
// Runtime types generated with workerd@1.20260710.1 2025-09-27 nodejs_als
interface __BaseEnv_Env {
	OAUTH_KV: KVNamespace;
	MEDIA_BUCKET: R2Bucket;
	DB: D1Database;
	MEDIA_PUBLIC_URL: "http://localhost:3200";
	MCP_CLIENTS: "[{\"client_id\":\"claude-ai\",\"redirect_uris\":[\"https://claude.ai/api/mcp/auth_callback\"],\"name\":\"Claude.ai\",\"max_scopes\":[\"content:read\",\"content:write\"]}]";
	JWT_SECRET: string;
	DOCS_SECRET: string;
	MCP_ADMIN_PASSPHRASE: string;
}
